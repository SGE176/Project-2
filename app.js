...
// app.post('/registeration', checkNotAuthenticated, async (req, res) => {
//   try {
...
// }
//Fitness
app.use(cookieParser('FitnessSecure'));
app.use(session({
  secret: 'FitnessSecretSession',
...
const routes = require('./server/routes/fitnessRoutes.js')
app.use('/', routes);
